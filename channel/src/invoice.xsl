...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="invoiceDataChannel">
        <fo:root>
                    ...
                    <fo:block font-size="10pt">
                        <fo:table table-layout="fixed" width="100%" border-collapse="separate">
                            ...
                            <fo:table-header font-weight="bold">
                                ...
                                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                                    <fo:block font-size="15pt" text-align="center" font-weight="bold">Channel Sku Id</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                            ...
                            <fo:table-body>
                                <xsl:apply-templates select="orderItemChannelDataList"/>
                            </fo:table-body>
                        </fo:table>
                    </fo:block>
    ...
    <xsl:template match="orderItemChannelDataList">
        <fo:table-row>
            <fo:table-cell  border="1pt solid black" xsl:use-attribute-sets="tableBorder">
